...
ARTICLES.forEach(function(article){ //generate keywords based on article content and title, and constants.
  article.keywords = (article.post_title + " " + article.post_content /*+ " " + KEYWORDS_DEFAULT.join(" ") */)
                     .replace(/[\r\n]+/gm," ")       //one-line
                     .replace(/[\r\n]+/g, " ")       //one-line
...
ARTICLES.forEach(function(article, index){ //generate article README.md (simplified index.html ...) and index.html (with head)
  ...
  //get next articles (loop if it gets the end of the list)
  var NEXTARTICLES_TEMPLATE   = '<tr><td><a href="###HREF1###">###TITLE1###</a></td><td><a href="###HREF2###">###TITLE2###</a></td></tr>'
     ,NEXTARTICLES_PAIRAMOUNT = 5  // 5 pairs is a total of 10 "next articles".
     ,NEXTARTICLES_TEXT       = []
